...
/***/ function(module, exports, __webpack_require__) {
	...
	var scriptLoader = _interopRequireWildcard(__webpack_require__(1));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $script = _interopRequire(__webpack_require__(3));
	
	var Q = _interopRequire(__webpack_require__(2));
	
	function loadScript(moduleName, path) {
	
	  var successDefer = Q.defer();
	
	  // injectedModule - for testing only
	  $script.get(path, function (injectedModule) {
